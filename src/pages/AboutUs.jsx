import Image4 from "../assets/images/services-01.jpg"
import Image5 from "../assets/images/services-02.jpg"
import Image6 from "../assets/images/services-03.jpg"
import Image7 from "../assets/images/services-04.jpg"
import Image8 from "../assets/images/left-infos.jpg"
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="service-item">
                <div className="icon">
                  <img src={Image4} alt="discover SEO" className="templatemo-feature"/>
                </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="service-item">
                <div className="icon">
                  <img src={Image5}alt="data analysis" className="templatemo-feature"/>
                </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="service-item">
                <div className="icon">
                  <img src={Image6} alt="precise data" className="templatemo-feature"/>
                </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="service-item">
                <div className="icon">
                  <img src={Image7} alt="SEO marketing" className="templatemo-feature"/>
                </div>
